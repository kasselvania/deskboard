...
Phase 3E now has a review implementation. Its content-free diagnostic measured 945 whole-list Reminder records and a 280,671-byte complete envelope, authorizing outcome A: the retained-record cap increased from 500 to 1,000 while the 768 KiB envelope and 1 MiB Core/proxy limits stayed unchanged. The owner-invoked same-revision replacement released the accepted truncated pending envelope and applied the complete source without contract drift.
